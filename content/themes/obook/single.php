<?php get_header(); ?>
    ...
    <?php if (have_posts()): while (have_posts()): the_post(); ?>
        ...
        <?php get_template_part('template-parts/review-detail') ?>
        ...
        <div class="books-row books-row_color">
            ...
            <div class="card books-row__card" id="newbook1">
                <div class="card-image">
                  <img class="books-row__image" src="images/imagevide.png" id="newbook-im1">
                </div>
            ...
            <div class="card books-row__card" id="newbook2">
                <div class="card-image">
                  <img class="books-row__image" src="images/imagevide.png" id="newbook-im2">
                </div>
                <footer class="card-footer">
            ...
            <div class="card books-row__card" id="newbook3">
                <div class="card-image">
                  <img class="books-row__image" src="images/imagevide.png" id="newbook-im3">
                </div>
                <footer class="card-footer">
            ...
            <div class="card books-row__card" id="newbook4">
                <div class="card-image">
                  <img class="books-row__image" src="images/imagevide.png" id="newbook-im4">
                </div>
                <footer class="card-footer">
