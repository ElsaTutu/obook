...
<aside class="aside">
        <div class="comment">
            <div class="comment_item">
                <h2 class="comment_item_title" style="visibility: hidden">Oups, la page que vous avez demandé n'existe plus</h2>
                <h2 class="comment_item_title_404">Oups, la page que vous avez demandé n'existe plus</h2>
                <p class="comment_item_description_404">Cliquez <a href="<?= home_url();?>">ici</a> pour revenir à l'accueil </p>
                <p class="comment_item_description" style="visibility: hidden">Cliquez <a href="<?= home_url();?>">ici</a> pour revenir à l'accueil </p>
            </div>
