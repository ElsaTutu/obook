...
<?php if (in_array('author' && 'adminstrator',  $user->roles)) : ?>

<div class="perfil">
  <div class="perfil_detail">
          <img src="<?php echo get_stylesheet_directory_uri(); ?>/public/images/avatar.png" alt="Avatar" class="perfil_detail_img">
          <div class="perfil_detail_container">
              <h4 class="perfil_detail_name"><?php echo $current_user->user_login ?></h4> 
              <h5 class="perfil_detail_email"> <?php echo $current_user->user_email ?></h5>
              <h5 class="perfil_detail_membership">Membre depuis le : <?php echo $current_user->user_registered ?></h5>
          </div>
</div>
...
// display the comments connected with the current user logged
$args=array(
    'post_type' => 'post',
    'post_status' => 'publish',
...
<div class="perfil_comments">
            <h4 class="perfil_comments_title">Mes commentaires</h4>
            <div class="perfil_comment">
    ...
    <aside class="aside">
        <div class="comment">
            <div class="comment_item">
                <h2 class="comment_item_title">Veuillez vous connecter pour accéder à cette page</h2>
            </div>
...
<aside class="aside" style="visibility: hidden; height: 0px">
        <div class="comment">
            <div class="comment_item">
...
<div class="wrapper" style="visibility: hidden; height: 0px">
        ...
        <div class="search-form" style="height: 0px; height: 0px">
    
          <form method="post" id="search__form"  style="visibility: hidden; height: 0px">
            <div class="field">
            ...
            <div class="" id="searchBox2">
              ...
              <div class="field">
                <div class="control">
                  <div class="select">
                    ...
                    <option value="18">Tecnologie</option>
              ...
              <div class="field">
                <div class="control">
                        <input type="text" class="input" name="searchDate" placeholder="Date">
                </div>
              </div>
            </div>
    ...
    <div class="card" id="bookList"  style="visibility: hidden; height: 0px"></div> 

    <div class="card" id="bookDetail"  style="visibility: hidden; height: 0px"></div> 


    <div class="card card_title" id="bookNewsTitle" style="visibility: hidden; height: 0px">
      <p class="card__title">Actu des livres</p>           
    </div>

    <div class="card" id="bookNews" style="visibility: hidden; height: 0px">
